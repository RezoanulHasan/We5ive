...
const AddsBanner: React.FC = () => {
  return (
    <div className="mt-10  mb-20 bg-custom flex flex-col md:flex-row items-center justify-between  p-6 md:p-12 gap-6 md:gap-12 mx-4 md:mx-10 rounded-lg shadow-lg transition-all duration-500 hover:shadow-xl overflow-hidden">
